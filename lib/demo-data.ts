...
export const demoQuestions: Question[] = [
  {
    id: '1',
    question: 'What does it mean to "walk by faith, not by sight" in 2 Corinthians 5:7?',
    author: {
      name: 'Sarah Mitchell',
      username: 'sarahm',
    ...
    topAnswer: {
      ...
      preview: 'Walking by faith means trusting in God\'s promises and character even when circumstances suggest otherwise...'
    }
  },
  {
    id: '2',
    question: 'How should Christians respond to persecution according to the Bible?',
    author: {
      name: 'Michael Chen',
      username: 'michaelc',
  ...
  {
    id: '3',
    question: 'What is the biblical view on spiritual gifts? Are they still active today?',
    author: {
    ...
    topAnswer: {
      ...
      preview: 'Spiritual gifts are indeed active today, as Paul teaches in 1 Corinthians 12-14. The key is understanding their purpose...'
    }
  },
  {
    id: '4',
    question: 'Can someone explain the significance of the Trinity in simple terms?',
    author: {
      name: 'Emma Johnson',
      username: 'emmaj',
  ...
  {
    id: '5',
    question: 'What does the Bible say about handling conflict in Christian relationships?',
    author: {
      name: 'Jessica Lee',
      username: 'jessical',
  ...
  {
    id: '6',
    question: 'How do I know if I\'m truly saved? What are the signs of genuine salvation?',
    author: {
      name: 'Robert Kim',
      username: 'robertk',
    ...
    topAnswer: {
      ...
      preview: 'Genuine salvation is evidenced by a transformed life, love for God and others, and the fruit of the Spirit...'
    }
  }
];
...
export const getAnswersForQuestion = (questionId: string): Answer[] => {
  const answers: Record<string, Answer[]> = {
    '1': [
      {
        id: 'a1',
        answer: 'Walking by faith means trusting in God\'s promises and character even when circumstances suggest otherwise. It\'s about living with an eternal perspective, recognizing that what we see with our physical eyes is temporary, but what we believe by faith is eternal and true.\n\nThis verse calls us to rely on God\'s word rather than our feelings or what appears to be reality. When we walk by faith, we act on what God says is true, not what our circumstances tell us.',
        author: {
      ...
      {
        id: 'a2',
        answer: 'I think it means we should trust God even when things don\'t make sense. Like when Job went through all that suffering, he couldn\'t see why, but he trusted God anyway.',
        author: {
          name: 'Maria Garcia',
          username: 'mariag',
    ...
    '2': [
      {
        id: 'a3',
        answer: 'The Bible provides clear guidance on responding to persecution with grace, prayer, and unwavering faith. Jesus himself taught us to "bless those who curse you" and to pray for our enemies. This doesn\'t mean we should be passive, but rather that our response should reflect Christ\'s character.\n\nKey principles include: praying for persecutors, maintaining our witness, rejoicing in suffering, and trusting God\'s sovereignty. The early church in Acts provides excellent examples of this.',
        author: {
