...
interface ButtonProps {
    buttonType?: "primary" | "secondary" | "danger" | "warning" | "info" | "success";
...
const Button = ({ 
    ...
    const getVariantClasses = () => {
        ...
        if (buttonVariant === "outline") {
            const typeColors = {
                primary: "border-2 border-[#5d4a2f] text-[#5d4a2f] hover:bg-[#5d4a2f] hover:text-white",
                secondary: "border-2 border-[#8b6f47] text-[#8b6f47] hover:bg-[#8b6f47] hover:text-white",
                danger: "border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white",
                warning: "border-2 border-amber-600 text-amber-600 hover:bg-amber-600 hover:text-white",
                info: "border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white",
                success: "border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white"
            };
            return `${baseClasses} ${typeColors[buttonType]}`;
        }
        ...
        // Solid variant
        const typeColors = {
            primary: "bg-[#5d4a2f] text-white hover:bg-[#3d2817] shadow-md hover:shadow-lg",
            secondary: "bg-[#8b6f47] text-white hover:bg-[#6b5d4a] shadow-md hover:shadow-lg",
