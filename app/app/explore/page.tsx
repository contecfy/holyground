...
const demoChurches: Church[] = [
  {
    ...
    description:
      "A welcoming community focused on biblical teaching and authentic relationships. We believe in the power of God's word to transform lives.",
    memberCount: 450,
    distance: 2.3,
    tags: [
  ...
  },
  {
    ...
    description:
      "Traditional worship with a heart for missions. We are committed to spreading the gospel both locally and globally.",
    memberCount: 320,
    distance: 3.7,
  ...
  },
  {
    ...
    description:
      "Rooted in Reformed theology, we seek to glorify God through worship, discipleship, and service to our community.",
    memberCount: 280,
    distance: 8.2,
    tags: [
      "Reformed Theology",
  ...
  },
  {
    ...
    description:
      "A vibrant, Spirit-filled community passionate about worship, prayer, and seeing God move in powerful ways.",
    memberCount: 520,
    distance: 4.1,
  ...
  },
  {
    ...
    description:
      "Verse-by-verse Bible teaching in a casual, welcoming atmosphere. Come as you are and experience God's love.",
    memberCount: 380,
    distance: 12.5,
    tags: [
      "Bible Teaching",
    ...
    <Card variant="elevated" className="p-6 hover:shadow-xl transition-shadow">
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          {/* Description */}
          <p className="text-[#3d2817] mb-4 line-clamp-2">
            {church.description}
          </p>
          ...
          <Card variant="paper" className="p-4">
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {denominations.map((denom) => (
                    <Badge
                      key={denom}
                      variant={
                        selectedDenomination === denom.toLowerCase()
                          ? "primary"
                          : "default"
                      }
                      size="md"
                      ...
                      onClick={() =>
                        setSelectedDenomination(denom.toLowerCase())
                      }
                    >
                      {denom}
                    </Badge>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Input label="City" placeholder="Enter city" variant="filled" />
                <Input
                  label="State"
      ...
      <div className="space-y-4">
        {filteredChurches.length > 0 ? (
          ...
          <Card variant="paper" className="p-12 text-center">
            ...
            <p className="text-[#6b5d4a] text-sm mt-2">
