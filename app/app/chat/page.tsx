...
export default function ChatPage() {
  ...
  const messages = selectedChat ? [
    { id: '1', sender: 'johndoe', text: 'Hey, how are you?', timestamp: '10:30 AM' },
    { id: '2', sender: 'me', text: 'I\'m doing well, thanks!', timestamp: '10:32 AM' },
    { id: '3', sender: 'johndoe', text: 'Thanks for the prayer!', timestamp: '10:35 AM' },
  ] : [];
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <p className="font-semibold text-[#3d2817] truncate">{chat.name}</p>
                      <span className="text-xs text-[#6b5d4a] flex-shrink-0 ml-2">{chat.timestamp}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-[#6b5d4a] truncate">{chat.lastMessage}</p>
                      {chat.unread > 0 && (
            ...
            <>
              ...
              <div className="p-4 border-b border-[#d4c4b0] flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-[#3d2817]">{currentChat?.name}</p>
                    <p className="text-xs text-[#6b5d4a]">@{currentChat?.username}</p>
                  </div>
                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className={`text-xs mt-1 ${
                        message.sender === 'me' ? 'text-white/70' : 'text-[#6b5d4a]'
                      }`}>
                        {message.timestamp}
                      </p>
                    </div>
