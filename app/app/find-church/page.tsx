...
const mockChurches: Church[] = [
  {
    ...
    description: 'A welcoming community focused on biblical teaching and authentic relationships.',
    memberCount: 450,
  ...
  },
  {
    ...
    description: 'Building hope and faith in our community through worship and service.',
    memberCount: 280,
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-6">
        ...
        <p className="text-[#6b5d4a]">Discover churches in your area and connect with local believers</p>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          <div className="space-y-3 lg:space-y-4">
            {filteredChurches.length > 0 ? (
              ...
              <Card variant="paper" className="p-8 text-center">
                <p className="text-[#6b5d4a]">No churches found. Try adjusting your filters.</p>
              </Card>
            )}
          </div>
        </div>
        ...
        <div className="hidden lg:block lg:col-span-5">
          <div className="sticky top-4 space-y-4">
            ...
            <Card variant="paper" className="p-4">
              <h3 className="text-lg font-semibold text-[#3d2817] mb-3">Map View</h3>
            ...
            {selectedChurch && (
              <Card variant="paper" className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-lg font-semibold text-[#3d2817]">Church Details</h3>
                  <button
                ...
                <div className="space-y-3 max-h-[300px] overflow-y-auto">
                  <div>
                    <h4 className="font-bold text-[#3d2817] mb-1">{selectedChurch.name}</h4>
                  ...
                  {selectedChurch.description && (
                    <p className="text-sm text-[#6b5d4a]">{selectedChurch.description}</p>
                  )}
                  <div className="text-sm text-[#6b5d4a] space-y-1">
                    <div className="flex items-center gap-2">
                      <MapPin size={14} className="text-[#8b6f47]" />
                      <span>{selectedChurch.address}, {selectedChurch.city}</span>
                    </div>
                    ...
                    {selectedChurch.memberCount && (
                      <div className="flex items-center gap-2">
                        ...
                        <span>{selectedChurch.memberCount.toLocaleString()} members</span>
                      </div>
                    )}
                  </div>
                  <Link 
        ...
        <div className="fixed inset-0 z-50 bg-white">
          <div className="h-full flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-[#e8dfd0] bg-white">
              <h2 className="text-xl font-bold text-[#3d2817]">Map View - Kampala, Uganda</h2>
              <button
                onClick={() => {
                  setShowMap(false);
                  setSelectedChurch(null);
