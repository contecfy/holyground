          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-[#e8dfd0]">
              <div className="text-center">
                <p className="text-lg md:text-xl font-bold text-[#3d2817]">
                  {stats.questions}
                </p>
        ...
        <div className="space-y-4">
          <Card variant="elevated" className="p-4">
            ...
            <p className="text-[#3d2817] mb-3">
              Walking in the Spirit means living in alignment with God&apos;s
              will, allowing the Holy Spirit to guide your thoughts, actions,
              and decisions...
            </p>
